...
(function () {
    ...
    window.vars.getTime = function(picker) {
        ...
        $("#timePicker")[0].innerHTML = `<div class="header">Choose Hour<button class="closeBtn"></button></div><div class="hours"><div class="am"><input type="radio" name="ampm" id="am" value="am" checked>
						<label for="am">AM</label></div><div class="pm"><input type="radio" name="ampm" id="pm" value="pm"><label for="pm">PM</lable></div><br/>
        ...
        $(".hours li").click(function () {
            ...
            $("#timePicker")[0].innerHTML = `<div class="header">Choose Minute</div><div class="minutes"><ul><li>05</li><li>10</li><li>15</li><li>20</li><li>25</li>
